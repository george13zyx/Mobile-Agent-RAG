...
def main(args,query):
    ...
    question_text = query
    retrieved_docs = retriever.search_document(question_text, args.n_docs)

    output = {
        "question": question_text,
        "retrieved_docs": [{"id": doc["id"], "text": doc["text"], "title": doc["title"]} for doc in retrieved_docs]
    }
