from inference_agent_RAG import run_single_task
from inference_agent_RAG import Perceptor, DEFAULT_PERCEPTION_ARGS, ADB_PATH, INIT_TIPS, INIT_SHORTCUTS, REASONING_MODEL
import torch
import os
import json
import shutil
...
def main():
    ...
    if args.log_root is None:
        args.log_root = f"logs/{REASONING_MODEL}/mobile_agent_rag"
